// src/app/api/SEU-WEBHOOK/route.ts  (ajuste o caminho se for outro)
// NÃO use next/config no App Router. Use process.env.
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (
      ...
      // IP do request (pode vir "ip1, ip2")
